...
** Ongoing Research
*** Where's Value? Using VAT data to improve compliance (with [[https://are.berkeley.edu/~aprajit/][Prof Aprajit Mahajan]])
*** Information Provision and Participatory Budgeting: Mohalla Sabhas in Delhi (with Prof Aprajit Mahajan, [[http://www.anderson.ucla.edu/degrees/phd/phd-students/gem/fiorin][Stefano Fiorin]])
** Research Experience
*** World Values Survey
