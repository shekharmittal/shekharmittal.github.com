...
\usepackage{hyperref}
\tolerance=1000
\usepackage[left=2cm,top=1.8cm,right=2cm,bottom=2cm,nohead,nofoot]{geometry}
\usepackage{bbding}
\usepackage{multicol}
\usepackage{eurosym}
...
\setsansfont[Scale=MatchLowercase,Mapping=tex-text]{Linux Libertine O}
\setmonofont[Scale=MatchLowercase]{MgOpen Modata}
\usepackage{hyperref}
\definecolor{linkcolour}{rgb}{0,0,0.6}
\hypersetup{colorlinks,breaklinks,urlcolor=linkcolour, linkcolor=linkcolour}
\pagestyle{empty}
\usepackage{enumitem}
\setitemize[0]{leftmargin=*,itemsep=0pt,parsep=1pt,topsep=1pt}
...
\vspace{1em}
{\normalsize 740 Weyburn Terrace, Apartment C12, Los Angeles, CA 90024\\
...
\flushleft
University of California, Los Angeles, \textbf{Anderson School of Management} \hfill September 2013 -- Current\\
Ph.D., Global Economics and Management\\
Areas of Interest: Political Economy, Development, India.\\
\vspace{1em}
University of Chicago, \textbf{Harris School of Public Policy} \hfill September 2011 -- June 2013\\
